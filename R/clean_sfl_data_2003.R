...
clean_sfl_data_2003 <- function(data, save = FALSE) {
  ...
  model_dat <-
    data |>
    dplyr::select(
      EMPSTAT,  #WORKINGSTATUS2,     # 724 - Whether working (paid work, government training scheme, own business, or unpaid work for relatives)
      ...
      # outcomes
      ITSKILL,  #SUMMARYCOMP,        # self-assessed computer skills (summary)
      ICTPRAC,  #TSKILLA,            # self-assessed computer skills (summary 2)
      READING,  #COMBLIT,            # self-assessed reading a writing (summary)
      WRITING,
      ...
      # weights
      POPWTALL, or WTALL,  #rimweight2003,
      POPWTLIT, or WTLIT,  #rimweightLIT2003,
      POPWTNUM, or WTNUM,  #rimweightNUM2003,
      # rimweightICT2003,
      # rimweightNUMICT2003,
      # rimweightLITICT2003,
      POPWTBOTH, or WTBOTH  #rimweightLITNUM2003
    ) |>
