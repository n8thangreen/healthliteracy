...
lfs_data <-
  read.delim("C:/Users/n8tha/Documents/Newham Council Fellowship/data/LFS/UKDA-9323-tab/tab/lfsp_js24_eul_pwt24.tab")
...
sim_struc <- simStructure(
  data = inp,
  method = "direct",
  basicHHvars = names(target_counts_list))

sim_pop_obj <- simCategorical(
  simPopObj = sim_struc,
...
save(synth_data, file = "data/synth_data.rda")
